const Banner = () => {
    return (
        <section className="container mx-auto flex gap-4 lg:gap-8 justify-between p-0! mb-8">
            <div className="w-[32%] lg:w-[35%] bg-gray-800 p-4 shadow-xl rounded-xl overflow-hidden">
                <h2 className="text-xl lg:text-5xl font-bold mb-2">8+</h2>
                <p className="text-[10px] lg:text-sm">Years in development</p>
            </div>
            <div className="w-[32%] lg:w-[27%] bg-gray-800 p-4 shadow-xl rounded-xl overflow-hidden">
